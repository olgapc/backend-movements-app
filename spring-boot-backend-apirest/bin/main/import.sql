...
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('663e3f65-a53f-4e13-987b-adad8d79d84e', 'Primera subtasca',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 1, 0, 0, 0);
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('973576c9-8944-4669-940e-c5aecde47066', 'Segona subtasca de tasca1',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 1, 0, 0, 0);
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('7071f4d9-f179-4169-89c7-6ab63f56f744', 'Tercera subtasca de tasca1',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 1, 0, 0, 0);
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('053b7019-497f-42e3-b8cf-4212cd18305d', 'subtasca de tercera subtasca',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 1, 0, 0, 0);
...
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('c851738f-2693-4551-a6ea-02b142fde52c', 'Primera subtasca de plantilla',  1, 1, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 0, 0, 0, 0);
...
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('de26d7f5-d8a6-4ed0-a689-0bcdb8943e3b', 'Subtasca de plantilla 1',  1, 1, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 0, 0, 0, 0);
...
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('bb4f6145-5bf1-4ba5-bc83-75e5d328e14a', 'Primera subtasca de segona tasca',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 2, 0, 0, 0, 0);
...
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('a295dde5-4ac1-4db4-99a3-711ce4839d0e', 'Primera subtasca de tercera tasca amb empresa diferent de tasca principal',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 2, 0, 0, 1, 0);
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('3cfc3b9c-3d6b-40f6-b358-001cd152b091', 'Segona subtasca de tercera tasca amb empresa diferent de tasca principal',  1, 0, 2, 'DAILY', '2020-12-31', NOW(), 3, 0, 0, 1, 0);
INSERT INTO tasks (id, description, is_to_send, is_template, number_to_calculate_deadline, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, is_visible, is_periodically) VALUES ('d5993fcf-7d50-497b-9482-6bee303d3a4e', 'Primera subtasca de plantilla',  1, 1, 2, 'DAILY', '2020-12-31', NOW(), 3, 1, 0, 0, 0, 0);
...
INSERT INTO task_sequences (subtask_fk, pretask_fk, create_at, comment, position) VALUES ('663e3f65-a53f-4e13-987b-adad8d79d84e', 'e3b144bc-4aab-4ec7-b1ed-120270c0e288', NOW(), 'subtasca de la tasca 1', 0);
INSERT INTO task_sequences (subtask_fk, pretask_fk, create_at, comment, position) VALUES ('973576c9-8944-4669-940e-c5aecde47066', 'e3b144bc-4aab-4ec7-b1ed-120270c0e288', NOW(), 'subtasca2 de la tasca 1', 1);
INSERT INTO task_sequences (subtask_fk, pretask_fk, create_at, comment, position) VALUES ('7071f4d9-f179-4169-89c7-6ab63f56f744', 'e3b144bc-4aab-4ec7-b1ed-120270c0e288', NOW(), 'subtasca3 de la tasca 1', 2);
INSERT INTO task_sequences (subtask_fk, pretask_fk, create_at, comment, position) VALUES ('053b7019-497f-42e3-b8cf-4212cd18305d', '7071f4d9-f179-4169-89c7-6ab63f56f744', NOW(), 'subtasca de la subtasca 3', 0);
INSERT INTO task_sequences (subtask_fk, pretask_fk, create_at, comment, position) VALUES ('bb4f6145-5bf1-4ba5-bc83-75e5d328e14a', 'f5b54e1f-6634-4321-b3ee-7198dec01a2b', NOW(), 'subtasca1 de la segona tasca', 0);
