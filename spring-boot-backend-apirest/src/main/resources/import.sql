...
/* POPULATE TASKS */
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask) VALUES ('Primera tasca', 1, 1, 0, 2, 'DAILY', '2020-12-31', NOW(), 1, 0, 1);
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, maintask_fk) VALUES ('Primera subtasca', 1, 1, 0, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 0, 0, 1);
...
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, maintask_fk) VALUES ('Primera subtasca de plantilla', 1, 1, 1, 2, 'DAILY', '2020-12-31', NOW(), 1, 1, 0, 0, 3);
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask) VALUES ('Segona tasca sense treballador', 1, 1, 0, 2, 'DAILY', '2020-12-31', NOW(), 2, 0, 1);
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask, maintask_fk) VALUES ('Primera subtasca de segona tasca', 1, 1, 0, 2, 'DAILY', '2020-12-31', NOW(), 2, 0, 0, 5);
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, is_done, is_maintask) VALUES ('Tercera tasca sense empresa', 1, 1, 0, 2, 'DAILY', '2020-12-31', NOW(), 0, 1);
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, is_done, is_maintask, maintask_fk) VALUES ('Primera subtasca de tercera tasca amb empresa diferent de tasca principal', 1, 1, 0, 2, 'DAILY', '2020-12-31', NOW(), 2, 0, 0, 7);
...
INSERT INTO tasks (description, is_optional_subtask, is_to_send, is_template, number_to_calculate_deadline_to_alarm, type_calculation_deadline, deadline, create_at, company_fk, employee_fk, is_done, is_maintask, maintask_fk) VALUES ('Primera subtasca de plantilla', 1, 1, 1, 2, 'DAILY', '2020-12-31', NOW(), 3, 1, 0, 0, 3);
